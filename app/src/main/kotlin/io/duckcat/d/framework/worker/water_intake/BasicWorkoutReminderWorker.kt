...
@HiltWorker
class BasicWorkoutReminderWorker @AssistedInject constructor(
    @Assisted context: Context,
    @Assisted workerParameters: WorkerParameters
) : CoroutineWorker(context, workerParameters) {

    // Optionally inject appPreferences if needed
    ...
    companion object {
        ...
        private fun foregroundServiceNotification(context: Context): Notification {
            val channelId = "basic_workout_reminder_foreground_channel_id"
            val channelName = "Basic Workout Reminder Foreground Service"
            val builder = NotificationCompat.Builder(context, channelId)
                .setSmallIcon(R.drawable.activity) // Replace with your drawable
                .setContentTitle(context.getString(R.string.basic_workout_reminder_title))
                .setContentText(context.getString(R.string.basic_workout_reminder_text))
        ...
        private fun createNotificationChannel(context: Context): Notification {
            val channelId = "basic_workout_reminder_channel_id"
            val channelName = context.getString(R.string.basic_workout_reminder_channel_name)
            val builder = NotificationCompat.Builder(context, channelId)
                .setSmallIcon(R.drawable.activity) // Replace with your drawable
                .setContentTitle(context.getString(R.string.basic_workout_reminder_title))
                .setContentText(context.getString(R.string.basic_workout_reminder_text))
