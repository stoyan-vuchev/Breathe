package io.duckcat.d.core.ui.components.topbar.day_view_topbar
...
import io.duckcat.d.core.ui.components.topbar.TopBarScrollBehavior
import io.duckcat.d.core.ui.components.topbar.settleAppBar
import io.duckcat.d.core.ui.theme.BreathDefaultColors
import io.duckcat.d.core.ui.theme.BreathTheme
import io.duckcat.d.core.utils.TimestampUtils
    ...
    LaunchedEffect(Unit) {
        coroutineScope.launch {
            when (val result = appPreferences.getUser()) {
                is io.duckcat.d.core.etc.Result.Success -> username = result.data ?: "Guest"
                is io.duckcat.d.core.etc.Result.Error -> username = "Guest"
            }
        }
    }
